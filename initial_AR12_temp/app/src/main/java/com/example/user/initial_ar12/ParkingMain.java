...
public class ParkingMain extends FragmentActivity implements Runnable{
    ...
    {
        AirPollution_Painting Air_painting=new AirPollution_Painting(this);
        //通知view組件重繪
        getWindow().addContentView(Air_painting,new FrameLayout.LayoutParams(800, 200, Gravity.TOP| Gravity.RIGHT));
    }
